// components/ReferenceModelUploader.tsx
import React, { useState, useCallback } from 'react';
import { useDropzone } from 'react-dropzone';
import { useAuth } from '../src/contexts/AuthContext';

const ReferenceModelUploader: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    formData.append('name', 'reference-model'); // Identificador para o backend
    ...
    <div className="border-dashed border-2 p-4 rounded-md text-center bg-gray-50">
      <div {...getRootProps()} className="cursor-pointer">
        ...
        {file ? (
          ...
          <p className="text-sm text-gray-500">Referência de Modelo</p>
        )}
      </div>
      {file && (
        <div className="mt-2">
...
export default ReferenceModelUploader;
